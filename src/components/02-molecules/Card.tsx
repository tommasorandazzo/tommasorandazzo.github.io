...
export default ({ imageAlt, imageSrc, heading, description, ctaLink, ctaOnclick, ctaText, classes }: { imageAlt?: string, imageSrc?: string, heading: string, description?: string|ReactNode, ctaLink?: string, ctaOnclick?: Function, ctaText?: string|ReactNode, classes?: string|string[] }) => {
  return (
